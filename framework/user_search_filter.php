                ...
                <div class="page-content">
                    ...
                    <div class="toolbar">
                        <ul>
                            ...
                            <li><a style="background-color: #078025; color: white;" href="user_search_filter.php">by Filters</a></li>
                        </ul>
                    </div>
                    <div class="bgimage">
                        <table class="mainframe">
                            <tr>
                                <td>
                                    <div class="container">
                                        <form action="user_search_filter.php" method="post">
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        $filtertype = mysqli_real_escape_string($conn, $_POST['filtertype']);

                                        $sql = "SELECT userid, firstname, lastname, useremail, username, usertype, userstatus
                                                FROM users
                                                WHERE usertype = ? OR userstatus = ?";

                                        $stmt = $conn->prepare($sql);
                                        $stmt->bind_param("ss", $filtertype, $filtertype);  
                                        $stmt->execute();
