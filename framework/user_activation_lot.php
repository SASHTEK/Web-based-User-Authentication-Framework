                ...
                <div class="page-content">
                    ...
                    <div class="toolbar">
                        <ul>
                            ...
                            <li><a href="user_activation.php">Single</a></li>
                            <li><a style="background-color: #078025; color: white;" href="user_activation_lot.php">Lot</a></li>
                        </ul>
                    </div>
                    <div class="bgimage">
                        <table class="mainframe">
                            <tr>
                                <td>
                                    <div class="container">
                                        <form action="user_activation_lot.php" method="post">
                                        <select name="statustype" id="statustype" required>
                                        <?php include 'lists\userstatus.php'; ?>
                                        </select><br>
                                    ...
                                    <?php
                                        ...
                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                            $status = mysqli_real_escape_string($conn, $_POST['statustype']);

                                            $sql = "SELECT userid, firstname, lastname, username, usertype, userstatus FROM users WHERE userstatus = ?";
